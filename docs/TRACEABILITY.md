...
| US-02 查看实时/历史行情和周期 | FR-003、FR-004、FR-005 | AC-02、AC-03、AC-06 | TASK-005、TASK-008、TASK-010、TASK-029、TASK-030 | T-07、T-08、T-11、T-16；K线Parquet缓存、增量补缺、陈旧Quote、实时订阅取消/重连、图表点渲染、周期/范围/复权/叠加层、实时增量更新、东方财富短重试、Yahoo日K/quote备用源、同花顺优先路由和搜索断开后继续拉取行情测试 |
