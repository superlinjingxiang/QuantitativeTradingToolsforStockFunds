...
| US-04 查看概率化预期走势 | FR-007、FR-020至FR-022 | AC-05、AC-10 | TASK-019、TASK-020、TASK-046、TASK-055、TASK-056 | T-12、T-13；校准概率预测、收益分位数、期望回撤、Brier/LogLoss/ECE、持有期不重叠评估、训练标签隔离、独立样本门槛、22标的1/3/5/10/21日验证、短线5日与长线10日终点、策略/预测窗口分离、Vue终点图、旧缓存失效、样本不足/分布外/漂移/低置信度不交易和GUI预期走势面板测试 |
...
| ETF V11双周期确认候选审计 | FR-013至FR-015、FR-020至FR-022 | EPV-001至EPV-006 | TASK-027、TASK-045、TASK-047至TASK-050 | `tests/unit/test_etf_rotation_validation.py`覆盖252/126日同时为正、未来K线隔离、确认窗口约束和被拒绝候选不能成为生产默认；固定十ETF开发段、全样本、多留出和容量负结果见`research/SHORT_TERM_STRATEGY_V11_DUAL_HORIZON_CANDIDATE_2026-07-20.md`；ADR-055锁定默认仍为V10单周期 |
| ETF V12跳过最近一月候选审计 | FR-013至FR-015、FR-020至FR-022 | EPV-001至EPV-006 | TASK-027、TASK-045、TASK-047至TASK-051 | `tests/unit/test_etf_rotation_validation.py`覆盖`t-21`排名端点、被排除21根K线的排名隔离、跳过窗口约束和生产默认保护；预注册见`research/SHORT_TERM_STRATEGY_V12_SKIP_MONTH_PREREGISTRATION_2026-07-20.md`，开发段失败与未读取留出证据见`research/SHORT_TERM_STRATEGY_V12_SKIP_MONTH_CANDIDATE_2026-07-20.md`；ADR-056锁定默认仍为V10单周期 |
| ETF V13逆方差降仓候选审计 | FR-013至FR-015、FR-020至FR-022 | EPV-001至EPV-006 | TASK-027、TASK-045、TASK-047至TASK-052 | `tests/unit/test_etf_rotation_validation.py`覆盖高波动时更强降仓、低波动无杠杆、排名一致、未来K线隔离、生产默认保护和紧凑报告暴露参数；预注册见`research/SHORT_TERM_STRATEGY_V13_INVERSE_VARIANCE_PREREGISTRATION_2026-07-20.md`，开发/最终顺序验证、容量和未进入生产边界见`research/SHORT_TERM_STRATEGY_V13_INVERSE_VARIANCE_CANDIDATE_2026-07-20.md`；ADR-057保持V10默认并要求模拟盘 |
| ETF V13多起点影子持有段验证 | FR-013至FR-015、FR-020至FR-022 | EPV-001至EPV-006 | TASK-027、TASK-045、TASK-049、TASK-052、TASK-053 | `tests/unit/test_etf_rotation_validation.py`覆盖互不重叠调仓段、分段收益与完整回测对账、选择一致、高波动下行改善、后续K线隔离和非暴露参数差异拒绝；预注册见`research/SHORT_TERM_STRATEGY_V13_SHADOW_EPISODE_PREREGISTRATION_2026-07-20.md`，全样本和20%/25%/30%多起点证据见`research/SHORT_TERM_STRATEGY_V13_SHADOW_EPISODE_VALIDATION_2026-07-20.md`；ADR-058保持V10生产默认并要求双轨模拟盘 |
