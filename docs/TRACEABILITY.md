...
| US-09 策略盈利证据深化 | FR-022、FR-013至FR-015、FR-020、FR-021、C-006 | EPV-001至EPV-006 | TASK-027、TASK-034、TASK-035、TASK-036、TASK-038、TASK-039 | `tests/unit/test_profit_validation_strategy.py`覆盖周期/交易次数、量能/趋势效率、阈值无泄漏、风险调整比较、全折滚动前推一致性、固定路径成本压力、目标波动仓位/无杠杆、实际暴露成本、数据快照、ETF与混合十标的池；`tests/unit/test_decision_hub.py`覆盖Sharpe、基准回撤和成本证据MISSING/FAIL门禁；`tests/unit/test_eastmoney_provider.py`和`tests/unit/test_multi_source_provider.py`覆盖长历史前复权、历史截断及空响应切源；GUI测试覆盖策略联动、平均暴露、回测页和证据卡；V4真实验证见`research/SHORT_TERM_STRATEGY_VALIDATION_V4_2026-07-13.md`，V3历史记录见`research/SHORT_TERM_STRATEGY_VALIDATION_2026-07-13.md`；后续仍需A股独立策略、容量/涨跌停/停牌压力、模拟盘偏差和完整过拟合模型卡 |
