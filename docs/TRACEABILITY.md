...
| US-09 策略盈利证据深化 | FR-022、FR-013至FR-015、FR-020、FR-021、C-006 | EPV-001至EPV-006 | TASK-027、TASK-034、TASK-035、TASK-036、TASK-038至TASK-043 | `tests/unit/test_profit_validation_strategy.py`覆盖周期/交易次数、量能/趋势效率、阈值无泄漏、风险调整比较、全折滚动前推一致性、固定路径成本压力、目标波动仓位/无杠杆、实际暴露成本、数据快照、A股反追涨与ETF分流、收盘信号次日开盘退出、日线止损峰值无前视、A股T+1、一字涨停拒买、一字跌停延迟卖出、按时点市场门槛和相对强弱、代理上升/下降/缺失、费后保本止损无前视、ETF不受影响、四组固定股票池互斥、账户同链门禁和执行真实性统计；`tests/unit/test_decision_hub.py`覆盖Sharpe、基准回撤和成本证据MISSING/FAIL门禁；GUI和FastAPI测试覆盖市场门槛阻断、策略版本和证据展示；V8候选及第四组留出验证见`research/SHORT_TERM_STRATEGY_VALIDATION_V8_CANDIDATE_2026-07-14.md`，V7五组真实验证见`research/SHORT_TERM_STRATEGY_VALIDATION_V7_2026-07-14.md`；后续仍需ETF交易制度分类、盘口/容量压力、模拟盘成交偏差和完整过拟合模型卡 |
