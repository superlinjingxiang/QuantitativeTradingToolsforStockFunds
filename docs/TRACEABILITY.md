...
| US-09 策略盈利证据深化 | FR-022、FR-013至FR-015、FR-020、FR-021、C-006 | EPV-001至EPV-006 | TASK-027、TASK-034、TASK-035、TASK-036 | `tests/unit/test_profit_validation_strategy.py`覆盖周期/交易次数、量能/趋势效率、阈值无泄漏、风险调整比较、滚动前推一致性、ETF与混合十标的池；`tests/unit/test_decision_hub.py`覆盖Sharpe与基准回撤门禁；`tests/gui/test_app_shell.py`和`tests/gui/test_chart_workspace.py`覆盖策略联动、回测页和同轴信号层；真实验证见`research/SHORT_TERM_STRATEGY_VALIDATION_2026-07-12.md`；后续仍需容量/涨跌停/停牌压力、模拟盘偏差和完整过拟合模型卡 |
