...
| US-02 查看实时/历史行情和周期 | FR-003、FR-004、FR-005 | AC-02、AC-03、AC-06 | TASK-005、TASK-008、TASK-010、TASK-029 | T-07、T-08、T-11、T-16；K线Parquet缓存、增量补缺、陈旧Quote、实时订阅取消/重连、图表点渲染、周期/范围/复权/叠加层、实时增量更新、东方财富短重试、Yahoo日K/quote备用源和搜索断开后继续拉取行情测试 |
...
| GUI应用外壳 | FR-001至FR-010 | AC-01至AC-06 | TASK-008、TASK-009、TASK-010、TASK-029 | PySide6导入、状态健康映射、短数据健康横幅、联网错误弹窗、搜索候选、键盘确认、图表控件、非阻塞取消和类型化错误状态测试 |
