...
| US-09 策略盈利证据深化 | FR-022、FR-013至FR-015、FR-020、FR-021、C-006 | EPV-001至EPV-006 | TASK-027、TASK-034、TASK-035、TASK-036、TASK-038至TASK-040 | `tests/unit/test_profit_validation_strategy.py`覆盖周期/交易次数、量能/趋势效率、阈值无泄漏、风险调整比较、全折滚动前推一致性、固定路径成本压力、目标波动仓位/无杠杆、实际暴露成本、数据快照、A股反追涨与ETF分流、十A股行业桶及三组十标的池；`tests/unit/test_decision_hub.py`覆盖Sharpe、基准回撤和成本证据MISSING/FAIL门禁；`tests/unit/test_eastmoney_provider.py`和`tests/unit/test_multi_source_provider.py`覆盖长历史前复权、历史截断及空响应切源；GUI和Vue验证覆盖策略版本、核心指标、支持依据、平均暴露、回测页和证据卡；V5真实验证见`research/SHORT_TERM_STRATEGY_VALIDATION_V5_2026-07-13.md`，V4风险暴露记录见`research/SHORT_TERM_STRATEGY_VALIDATION_V4_2026-07-13.md`；后续仍需A股涨跌停/停牌/T+1与容量压力、模拟盘成交偏差和完整过拟合模型卡 |
