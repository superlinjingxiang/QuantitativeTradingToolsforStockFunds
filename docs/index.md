...
- 短线策略 V11 双周期确认候选研究（拒绝晋级）：research/SHORT_TERM_STRATEGY_V11_DUAL_HORIZON_CANDIDATE_2026-07-20.md
- 短线策略 V12 跳过最近一月候选预注册：research/SHORT_TERM_STRATEGY_V12_SKIP_MONTH_PREREGISTRATION_2026-07-20.md
- 短线策略 V12 跳过最近一月候选研究（开发段拒绝）：research/SHORT_TERM_STRATEGY_V12_SKIP_MONTH_CANDIDATE_2026-07-20.md
- 短线策略 V13 逆方差降仓候选预注册：research/SHORT_TERM_STRATEGY_V13_INVERSE_VARIANCE_PREREGISTRATION_2026-07-20.md
- 短线策略 V13 逆方差降仓候选研究（回测门槛通过，等待模拟盘）：research/SHORT_TERM_STRATEGY_V13_INVERSE_VARIANCE_CANDIDATE_2026-07-20.md
- 短线策略 V13 调仓影子持有段预注册：research/SHORT_TERM_STRATEGY_V13_SHADOW_EPISODE_PREREGISTRATION_2026-07-20.md
- 短线策略 V13 调仓影子持有段验证（全样本和多起点通过，仍待模拟盘）：research/SHORT_TERM_STRATEGY_V13_SHADOW_EPISODE_VALIDATION_2026-07-20.md
