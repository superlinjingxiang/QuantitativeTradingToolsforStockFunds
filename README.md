...
2026年7月13日完成盈利验证策略 V4 阶段改造：在 V3 的固定路径成本压力和全折滚动前推基础上，增加 20% 目标波动仓位、7.5% 跟踪止损、实际风险暴露和可复现数据快照。代码改动见 `docs/CHANGELOG_2026-07-13.md`，V4 方法与真实十标的结果见 `docs/research/SHORT_TERM_STRATEGY_VALIDATION_V4_2026-07-13.md`，V3 历史记录保留在 `docs/research/SHORT_TERM_STRATEGY_VALIDATION_2026-07-13.md`。

当前十 ETF 和混合十标的实验都只有 2/10 PASS，综合状态仍为 WATCH；五只 A 股为 0/5 PASS，不代表保证盈利。可使用以下命令复现：
