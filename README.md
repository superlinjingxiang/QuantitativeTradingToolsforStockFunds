...
最新工程进度快照见：`docs/PROJECT_STATUS_2026-07-20.md`。该文档汇总 FastAPI/Vue/Redis 迁移、行情与交互改造、荐股池、账户输入联动、短线策略 V2-V7、V8 候选否决、V9 固定十 ETF 候选、V10 差额调仓会计修正、预测校准 V2、组合证据与 DecisionHub 联动、ETF 容量/冲击成本和 T+0/T+1 门禁，以及当前仍未解除的交易边界。`docs/PROJECT_STATUS_2026-07-17.md` 保留为历史快照。
