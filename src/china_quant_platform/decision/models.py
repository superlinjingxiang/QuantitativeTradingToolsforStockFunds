...
class DecisionRequest(DomainModel):
    ...
    min_forecast_interval_coverage: float = Field(default=0.68, ge=0, le=1)
    max_forecast_downside_breach_rate: float = Field(default=0.22, ge=0, le=1)
    max_forecast_direction_brier_score: float = Field(default=0.30, ge=0, le=1)
